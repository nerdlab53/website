...
// To be able to do scene.add.linkPost(...)
Phaser.GameObjects.GameObjectFactory.register('linkPost', function (x, y, text, url, label) {
	return new LinkPost(this.scene, x, y, text, url, label);
})
